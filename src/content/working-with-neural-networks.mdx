...
analysis techniques . Thus, they are typically used in
...
- If one has a strong enough pc(with at least 16 GB RAM, M.2 SSD, RTX2080 super , i7 11th gen or ryzen 7 5000 series) they can do it on jupyter([https://jupyter.org/](https://jupyter.org/)) else use keggle([https://www.kaggle.com/](https://www.kaggle.com/))
