    ...
    <>
      <footer className="border border-t-[1px] border-b-0 border-r-0 border-l-0 border-textcolors-boundary bg-darkshades-passive py-2 font-Plex">
        <section className="grid sm:grid-cols-1 md:grid-cols-6 md:gap-2 lg:grid-cols-10">
          ...
          <section className="flex justify-between sm:col-start-1 sm:py-4 sm:px-2 md:col-span-2 md:col-start-3 lg:col-span-2 lg:col-start-4">
          ...
          <section className="sm:col-start-1 sm:flex sm:justify-start sm:py-4 sm:px-2 md:col-span-2 md:col-start-5 lg:col-span-2 lg:col-start-8">
